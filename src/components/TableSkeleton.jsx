export default function TableSkeleton({ rows = 5, cols = 6 }) {
  return (
    <div className="card overflow-hidden animate-pulse">
      {/* Header */}
      <div className="bg-gray-100 dark:bg-gray-800 px-4 py-3 flex gap-4">
        {[...Array(cols)].map((_, i) => (
...
export function ChartSkeleton({ height = 300 }) {
  return (
    <div className="card p-6 animate-pulse">
      ...
      <div
        className="bg-gray-100 dark:bg-gray-800 rounded-lg flex items-end justify-around gap-2 p-4"
        style={{ height }}
      >
