export const translations = {
  en: {
    ...
    compliance: {
      ...
      folders: {
        items_subtitle: 'Open a folder — Certificates, Tax, Licenses — to find what you need.',
        documents_subtitle: 'Papers organized by category, like folders on your desk.',
        other: 'Other',
        unfiled: 'Needs filing',
        back: 'All folders',
        count: '{count} items',
        empty_folder: 'Nothing in this folder matches your search.',
        quick_filters: 'Search papers',
        type_certificate: 'Certificates',
        type_license: 'Licenses',
        type_tax: 'Tax',
        type_permit: 'Permits',
        type_inspection_report: 'Inspection reports',
        type_invoice: 'Invoices',
        type_letter: 'Letters',
        type_scan: 'Scans',
      },
      view: {
      ...
      scan: {
        ...
        subtitle: 'Use your phone or webcam to capture a paper. It uploads to Inbox and AI reads it automatically.',
        button: 'Scan with camera',
        capture: 'Capture photo',
        starting: 'Starting camera…',
        camera_denied: 'Camera access was denied. Use the phone camera option below.',
        no_camera_api: 'Camera not available in this browser. Use the phone camera option.',
      ...
      mobile: {
        ...
        nav_scan: 'Scan',
        nav_queue: 'Queue',
        scan_headline: 'Scan a document',
        scan_subtitle: 'Take a photo or pick a file. AI reads it and adds it to your compliance papers.',
        view_queue: 'Needs your attention',
        open_full_desktop: 'Open full Compliance on desktop',
      },
      bulk: {
        failed_documents_title: 'Failed documents',
        failed_documents_hint: 'AI or upload failed — select and remove to clear your list.',
        select_all_failed: 'Select all failed',
        select_all: 'Select all',
        select: 'Select',
        delete_selected: 'Delete selected ({count})',
        delete_all_failed: 'Delete all failed',
        clear_failed_uploads: 'Clear failed uploads',
        deleted_count: '{count} document(s) deleted',
      },
      // Tabs
  ...
  ar: {
    ...
    compliance: {
      ...
      folders: {
        items_subtitle: 'افتح مجلداً — شهادات، ضرائب، تراخيص — لتجد ما تحتاجه بسهولة.',
        documents_subtitle: 'مستندات منظمة حسب التصنيف، مثل المجلدات على مكتبك.',
        other: 'أخرى',
        unfiled: 'بحاجة للأرشفة',
        back: 'كل المجلدات',
        count: '{count} عنصر',
        empty_folder: 'لا يوجد شيء في هذا المجلد يطابق بحثك.',
        quick_filters: 'بحث في المستندات',
        type_certificate: 'شهادات',
        type_license: 'تراخيص',
        type_tax: 'ضرائب',
        type_permit: 'تصاريح',
        type_inspection_report: 'تقارير تفتيش',
        type_invoice: 'فواتير',
        type_letter: 'خطابات',
        type_scan: 'مسح ضوئي',
      },
      ...
      scan: {
        title: 'مسح مستند',
        subtitle: 'استخدم هاتفك أو الكاميرا لالتقاط ورقة. تُرفع إلى الوارد ويقرأها الذكاء الاصطناعي تلقائياً.',
        button: 'مسح بالكاميرا',
        capture: 'التقاط صورة',
        starting: 'جارٍ تشغيل الكاميرا…',
        camera_denied: 'تم رفض الوصول للكاميرا. استخدم خيار كاميرا الهاتف أدناه.',
        no_camera_api: 'الكاميرا غير متاحة في هذا المتصفح. استخدم كاميرا الهاتف.',
        use_phone_camera: 'كاميرا الهاتف',
      },
      mobile: {
        title: 'مسح الامتثال',
        nav_scan: 'مسح',
        nav_queue: 'القائمة',
        scan_headline: 'مسح مستند',
        scan_subtitle: 'التقط صورة أو اختر ملفاً. يقرأه الذكاء الاصطناعي ويضيفه إلى أوراق الامتثال.',
        view_queue: 'بحاجة لانتباهك',
        open_full_desktop: 'فتح الامتثال الكامل على سطح المكتب',
      },
      bulk: {
        failed_documents_title: 'مستندات فاشلة',
        failed_documents_hint: 'فشل الرفع أو الذكاء الاصطناعي — اختر واحذف لتنظيف القائمة.',
        select_all_failed: 'تحديد كل الفاشل',
        select_all: 'تحديد الكل',
        select: 'تحديد',
        delete_selected: 'حذف المحدد ({count})',
        delete_all_failed: 'حذف كل الفاشل',
        clear_failed_uploads: 'مسح الرفع الفاشل',
        deleted_count: 'تم حذف {count} مستند',
      },
      // Tabs
      tab_dashboard: 'لوحة',
      tab_items: 'العناصر',
