  ...
  en: {
    ...
    compliance: {
      ...
      import: {
        ...
        orphan_help: 'This document has no compliance item yet. Create a new item for it or attach it to an existing one — Approve is locked until then.',
        orphan_created_item: 'Created item #{n}',
        orphan_linked_item: 'Linked to existing item',
        create_item_help: 'A new compliance item will be created from the extracted metadata (title, authority, dates). Defaults will fill where nothing was extracted.',
        link_existing_item_help: 'Pick the item to attach this document to. The extracted metadata will be applied automatically.',
  ...
  ar: {
    ...
    compliance: {
      ...
      import: {
        ...
        orphan_help: 'لا يوجد عنصر امتثال لهذا المستند بعد. أنشئ عنصراً جديداً أو اربطه بعنصر قائم — اعتماد المستند مغلق إلى أن يحدث ذلك.',
        orphan_created_item: 'تم إنشاء العنصر رقم {n}',
        orphan_linked_item: 'تم ربطه بعنصر موجود',
        create_item_help: 'سيتم إنشاء عنصر امتثال جديد من البيانات المستخرجة (العنوان، الجهة، التواريخ). تُملأ القيم الافتراضية لأي حقل فارغ.',
        link_existing_item_help: 'اختر العنصر الذي تريد إرفاق هذا المستند به. ستُطبَّق البيانات المستخرجة تلقائياً.',
